...
pub fn @"GET /jobs"(ctx: *RequestContext) !Response(.array) {
...
pub fn @"GET /jobs/:id"(ctx: *RequestContext) !Response(.object) {
    const conn: *slurm.db.Connection = try .open();
...
pub fn @"GET /accounts"(ctx: *RequestContext) !Response(.array) {
    const conn: *slurm.db.Connection = try .open();
...
pub fn @"GET /users"(ctx: *RequestContext) !Response(.array) {
    const conn: *slurm.db.Connection = try .open();
...
pub fn @"GET /associations"(ctx: *RequestContext) !Response(.array) {
    const conn: *slurm.db.Connection = try .open();
